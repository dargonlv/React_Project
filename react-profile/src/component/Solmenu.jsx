...
function Solmenu() {
    ...
    useEffect(()=>{
      ...
      document.querySelectorAll(".navsic").forEach((s,id)=>{
        if(id==select){
          s.classList.add("navsicafter")
        }else{
          s.classList.remove("navsicafter")
        }
    ...
    <div className='main'>
      ...
      <div className='nav'>
        <div className='navs'>
            ...
            <div onClick={ContactClick} className='navsic'> İletisim</div>
            <div onClick={AnasayfaClick} className='navsic'> Ana Sayfa</div>
            <div onClick={AnasayfaClick} className='navsic'> Ana Sayfa</div>
      ...
      <div className='solalt'>
        ...
        <a className='icback' href='https://www.instagram.com/fatihhmrl/'>
        ...
        <a className='icback' href='https://github.com/dargonlv'>
